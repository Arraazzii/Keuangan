                        ...
                        <div class="row" style="margin-top:30px">
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                ...
                                <ol class="breadcrumb breadcrumb-arrow">
                                    ...
                                    <li class="active"><span>Saldo Awal</span></li>
                                </ol>
                            </div>
                        </div>
                        <!-- Start Widget -->
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading"><h3 class="panel-title">Saldo Awal</h3>
                                    </div>
                                    <div class="panel-body">
                                        <div class=" form">
                                            <form class="cmxform form-horizontal tasi-form" id="commentForm" method="get" action="#" novalidate>
                                                ...
                                                <div class="form-group ">
                                                    <label for="cemail" class="control-label col-lg-2">Jumlah Saldo Awal *</label>
                                                    <div class="col-lg-4">
                                                        <input maxlength="18" type="text" class="form-control " id="saldoawal" name="saldoawal" required="true" aria-required="true">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                                        ...
                                                                        <table id="datatable1" class="table table-striped table-bordered">
                                                                            ...
                                                                            <tbody id="tbody">
                                                                                ...
                                                                                <?php if(isset($list[$i][0])){ echo $list[$i][0];} ?>
                                                                                    ...
                                                                                    <td class="td-<?php if(isset($list[$i][0])){ echo $list[$i][0];} ?>">
                                                                                        <textarea readonly name="uang" id="td-2-<?php if(isset($list[$i][0])){ echo $list[$i][0];} ?>" class="txt-<?php if(isset($list[$i][0])){echo $list[$i][0];}?>" name="" cols="5" rows="1" style="overflow:hidden;width: 100%; height:17px; background:none;border:none; resize:none;"><?php if(isset($list[$i][3])){ setlocale(LC_MONETARY,"en_US"); echo number_format($list[$i][3],2);} ?></textarea>
                                                                                    </td>
