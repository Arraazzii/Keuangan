...
<body class="fixed-left">
            ...
            <div class="content-page" style="min-height: 0px;">
                        ...
                        <div class="row" style="margin-top: 30px">
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                ...
                                <ol class="breadcrumb breadcrumb-arrow">
                                    ...
                                    <li class="active"><span>Departemen</span></li>
                                </ol>
                            </div>
                        </div>
                        <!-- Start Widget -->
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading"><h3 class="panel-title">Tambah Data Departemen</h3>
                                    </div>
                                        ...
                                        <div class=" form">
                                            <form class="cmxform form-horizontal tasi-form" id="commentForm" novalidate>
                                                <div class="form-group ">
                                                    ...
                                                    <div class="col-lg-10">
                                                        <input class=" form-control" id="nama_departemen" name="nama_departemen" type="text" required="" aria-required="true">
                                                    </div>
                                                </div>
                                                <div class="form-group ">
                                                    <label for="cemail" class="control-label col-lg-2">Penanggung Jawab *</label>
                                                    <div class="col-lg-10">
                                                        <input class="form-control " id="penanggung_jawab" type="text" name="penanggung_jawab" required="" aria-required="true">
                                                    </div>
                                                </div>
                                                <div class="form-group ">
                                                    <label for="ccomment" class="control-label col-lg-2">Keterangan *</label>
                                                    <div class="col-lg-10">
                                                        <textarea class="form-control " id="keterangan" name="keterangan" required aria-required="true"></textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                ...
                <!-- Start Widget -->
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading"><h3 class="panel-title">List Derpartemen</h3>
                                    </div>
                                    <div class="panel-body">
                                        <!-- table edit -->
                                        <div class="row">
    ...
    function cari() {
        ...
        $.ajax({
            type: "POST",
            url: "index.php?page=9176f6233d9bf1733d94155843e330d8&kode=4ff52963acc666306f1986689961951b",
    ...
    function tambah() {
        ...
        $.ajax({
            type: "POST",
            url: "index.php?page=9176f6233d9bf1733d94155843e330d8&kode=4ff52963acc666306f1986689961951b",
            data: 'aksi=tambah' + '&nama_departemen=' + nama_departemen + '&penanggung_jawab=' + penanggung_jawab + '&keterangan=' + keterangan,
            success: function(msg) {
                if (msg !== "gagal" || msg !== "") {
                    ...
                    var part3 = '<td class="td-' + msg + '"><textarea readonly id="td-3-' + msg + '" class="txt-' + msg + '"  name="" cols="5" rows="1" style="overflow:hidden;width: 100%; height:17px; background:none;border:none; resize:none;">' + penanggung_jawab + '</textarea></td>';
                    var part4 = '<td class="td-' + msg + '"><textarea readonly id="td-4-' + msg + '" class="txt-' + msg + '"  name="" cols="5" rows="1" style="overflow:hidden;width: 100%; height:17px; background:none;border:none; resize:none;">' + keterangan + '</textarea></td>';
