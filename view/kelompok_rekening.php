                        ...
                        <div class="row" style="margin-top:30px">
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                ...
                                <ol class="breadcrumb breadcrumb-arrow">
                                    ...
                                    <li class="active"><span>Kelompok Rekening</span></li>
                                </ol>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading"><h3 class="panel-title">Kelompok Rekening</h3>
                                    </div>
                                        ...
                                        <div class=" form">
                                            <form class="cmxform form-horizontal tasi-form" id="commentForm" method="get" action="#" novalidate>
                                                <div class="form-group ">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <input maxlength="3" type="text" class="form-control " id="nopokok_kelompokrekening" name="nopokok_kelompokrekening" required="" aria-required="true">
                                                    </div>
                                                </div>
                                                <div class="form-group ">
