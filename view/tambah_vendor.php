                       ...
                       <div class="row">
                            <div class="col-sm-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading"><h3 class="panel-title">Tambah Data Vendor</h3></div>
                                            ...
                                            <form class="cmxform form-horizontal tasi-form" id="commentForm" method="get" action="#" novalidate>
                                                ...
                                                <div class="col-lg-2">
                                                   <div class="input-group">
                                                    <input type="text" class="form-control" placeholder="No. NPWP" aria-required="true" required="true">
                                                    </div><!-- input-group -->
