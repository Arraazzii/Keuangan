                                            ...
                                            <form class="cmxform form-horizontal tasi-form" id="commentForm" novalidate>
                                                   ...
                                                   <input type="hidden" id="kode_awal" value="<?php $code =  $list2[0][1]; if(isset($code)){ $ex = explode("/", $code); echo $ex[0]."/".$ex[1]."/";} ?>">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="input-group">
                                                            <input type="text" name="change_date" class="form-control" placeholder="yyyy/mm/dd" id="datepicker3" value="<?php if(isset($list2[0][2])){ echo $list2[0][2];} ?>" <?php if ($list2[0][11] == 'Y') { echo 'disabled'; }?>>
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="col-lg-4">
                                                        ...
                                                        <!-- <input  id="rekening_danamasuk"  <?php if(isset($list2[0][4])){ if($list2[0][4] == "Bank"){ echo "checked";} } ?>  type="radio" name="rekening_danamasuk" required="" aria-required="true" value="Bank"> Bank -->
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <input class="form-control " id="nomorcekgiro_danamasuk" type="text" name="nomorcekgiro_danamasuk" required="" aria-required="true" disabled="disabled" value="<?php if(isset($list2[0][8])){ echo $list2[0][8];} ?>" <?php if ($list2[0][11] == 'Y') { echo 'disabled'; }?>>
                                                    </div>
                                                </div>
                                                <!--                                                 <div class="form-group ">-->
                                            ...
                                            <form class="cmxform form-horizontal tasi-form" id="commentForm" novalidate>
                                                ...
                                                <div class="form-group ">
                                                   ...
                                                   <input type="hidden" id="kode_awal" value="<?php $code =  $list2[0][1]; if(isset($code)){ $ex = explode("/", $code); echo $ex[0]."/".$ex[1]."/";} ?>"> 
                                                    ...
                                                    <div class="col-lg-2">
                                                        <div class="input-group">
                                                            <input type="text" name="change_date" class="form-control" placeholder="yyyy/mm/dd" id="datepicker3" value="<?php if(isset($list2[0][2])){ echo $list2[0][2];} ?>">
                                                            <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                                                        </div><!-- input-group -->
                                                    </div>
                                                    <label for="cemail" class="control-label col-lg-2">Dibayar Kepada</label>
                                                    ...
                                                    <table class="table table-striped table-bordered">
                                                        ...
                                                        <tbody id="tbody" onDblClick="tambah_row();">
                                                            ...
                                                            <tr class="tr" id="tr-<?php echo ($i+1); ?>">
                                                                ...
                                                                <td class="td-<?php echo ($i+1); ?>">
                                                                    <?php if ($list3[$i][4] === "Debet") {?>
                                                                    <textarea readonly id="td-3-<?php echo ($i+1); ?>" class="txt-<?php echo ($i+1); ?> debet_valuea" name="" cols="5" rows="1" style="overflow:hidden;width: 100%; height:17px; background:none;border:none; resize:none;"><?php if(isset($list3[$i][5])){ echo number_format($list3[$i][5], 2);} ?></textarea>
                                                                    <?php }else{ ?>
                                                                    <textarea readonly id="td-3-<?php echo ($i+1); ?>" class="txt-<?php echo ($i+1); ?> debet_valuea" name="" cols="5" rows="1" style="overflow:hidden;width: 100%; height:17px; background:none;border:none; resize:none;"></textarea>
                                                                    <?php } ?>
                                                                </td>
                                                                <td class="td-<?php echo ($i+1); ?>">
                                                                    <?php if ($list3[$i][4] === "Kredit") {?>
 ...
 <script src="js/jquery-1.7.2.js"></script>-->
    ...
    function ubah() {
        ...
        // }
            ...
            $.ajax({
                type: "POST",
                url: "index.php?page=40f57ec532ab642c6c632ee8f9eb6112&kode=210672dd918ab2ee98b69742ecae13b5",
        ...
        $.ajax({
            ...
            success: function(msg) {
                if (msg !== "gagal" || msg !== "") {
                    ...
                    window.location.replace("index.php?page=40f57ec532ab642c6c632ee8f9eb6112&kode=listdanakeluar");
                }
            }
        });
    }
