                        ...
                        <div class="row" style="margin-top:30px">
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                ...
                                <ol class="breadcrumb breadcrumb-arrow">
                                    ...
                                    <li class="active"><span>Format Laporan Aktivitas</span></li>
                                </ol>
                            </div>
                        </div>
                        <!-- Start Widget -->
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading"><h3 class="panel-title">Pengaturan Laporan Aktivitas</h3>
                                    </div>
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <select id="jenis" class="form-control">
                                                            ...
                                                            <option value="Pendapatan, Penghasilan">[Penerimaan]Pendapatan, Penghasilan</option>
                                                            <option value="Aktiva Bersih yang Berakhir Batasannya">[Penerimaan]Aktiva Bersih yang Berakhir Batasannya</option>
                                                            <option value="Biaya Program">[Pengeluaran]Biaya Program</option>
                                                            <option value="Biaya Umum">[Pengeluaran]Biaya Umum & Administrasi</option>
                                                            <option value="Biaya Pencarian Dana">[Pengeluaran]Biaya Pencarian Dana</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="form-group jenis2" id="s1">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <select id="pendapatan_penghasilan" class="form-control">
                                                            ...
                                                            <option value="Penghasilan Bunga Jasa Giro">Penghasilan Bunga Jasa Giro</option>
                                                ...
                                                <div class="form-group jenis2" id="s2">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <select id="aktiva_bersih" class="form-control">
                                                            <option value="Berakhir Karena Program">Berakhir Karena Program</option>
                                                            <option value="Berakhir Karena Waktu">Berakhir Karena Waktu</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="form-group jenis2" id="s3">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <select id="biaya_program" class="form-control">
                                                            <option value="Progam Bantuan Pendidikan Beasiswa">Progam Bantuan Pendidikan & Beasiswa</option>
                                                            <option value="Program Pengembangan SD">Program Pengembangan SD</option>
                                                            <option value="Program Pengembangan SMK">Program Pengembangan SMK</option>
                                                            <option value="Program Pengembangan Pesantren">Program Pengembangan Pesantren</option>
                                                            <option value="Program Perbaikan Gedung Sekolah">Program Pengembangan/Perbaikan Gedung Sekolah</option>                                                            
                                                            <option value="Program Perbaikan Gizi">Program Perbaikan Gizi</option>
                                                            <option value="Program COSI">Program COSI (Pemberdayaan Masyarakat)</option>
                                                            <option value="Program Investasi Sosial">Program Investasi Sosial</option>
                                                            <option value="Program Olahraga">Program Olahraga</option>
                                                            <option value="Program Bantuan Bencana Alam">Program Bantuan Bencana Alam</option>
                                                ...
                                                <div class="form-group jenis2" id="s4">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <select id="biaya_umum_administrasi" class="form-control">
                                                            ...
                                                            <option value="Biaya Keperluan Kantor">Biaya Keperluan Kantor</option>
                                                            <option value="Biaya Perjalanan Dinas">Biaya Perjalanan Dinas</option>
                                                            <option value="Biaya Transportasi Lokal">Biaya Transportasi Lokal</option>
                                                            <option value="Biaya Operasional">Biaya Operasional</option>
                                                            <option value="Biaya Bank">Biaya Bank</option>
                                                            <option value="Biaya Penyusutan">Biaya Penyusutan</option>
                                                            <option value="Biaya Pengembangan Software">Biaya Pengembangan Software</option>
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="col-lg-4">
                                                        <select id="status" class="form-control">
                                                            ...
                                                            <option value="Terikat Sementara">Terikat Sementara</option>
                                                            <option value="Terikat Permanen">Terikat Permanen</option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                                            ...
                                                                            <tbody id="tbody">
                                                                                ...
                                                                                <tr class="tr" id="tr-<?php if(isset($list[$i][0])){ echo $list[$i][0];} ?>">
                                                                                    ...
                                                                                    <td class="td-<?php if(isset($list[$i][0])){ echo $list[$i][0];} ?>">
                                                                                        <textarea readonly id="td-3-<?php if(isset($list[$i][0])){ echo $list[$i][0];} ?>" class="txt-<?php if(isset($list[$i][0])){echo $list[$i][0];}?>" name="" cols="5" rows="1" style="overflow:hidden;width: 100%; height:17px; background:none;border:none; resize:none;"><?php if(isset($list[$i][2])){ echo $list[$i][1];} ?></textarea>
                                                                                    </td>
                                                                                    <td class="td-<?php if(isset($list[$i][0])){ echo $list[$i][0];} ?>">
                                                                                    ...
                                                                                    <td class="td-<?php if(isset($list[$i][0])){ echo $list[$i][0];} ?>">
                                                                                        <textarea readonly name="uang" id="td-2-<?php if(isset($list[$i][0])){ echo $list[$i][0];} ?>" class="txt-<?php if(isset($list[$i][0])){echo $list[$i][0];}?>" name="" cols="5" rows="1" style="overflow:hidden;width: 100%; height:17px; background:none;border:none; resize:none;"><?php if(isset($list[$i][1])){ setlocale(LC_MONETARY,"en_US"); echo $list[$i][3];} ?></textarea>
                                                                                    </td>
                                                                                    <td class="td-<?php if(isset($list[$i][0])){ echo $list[$i][0];} ?>">
                                                                                        <textarea readonly name="uang" id="td-4-<?php if(isset($list[$i][0])){ echo $list[$i][0];} ?>" class="txt-<?php if(isset($list[$i][0])){echo $list[$i][0];}?>" name="" cols="5" rows="1" style="overflow:hidden;width: 100%; height:17px; background:none;border:none; resize:none;"><?php if(isset($list[$i][1])){ setlocale(LC_MONETARY,"en_US"); echo $list[$i][4];} ?></textarea>
                                                                                    </td>
                        ...
                        <div class="row" style="margin-top: -170px">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                ...
                                <ol class="breadcrumb breadcrumb-arrow">
                                    <li><a href="?page=3edbf72c17de6ffe453f9e729c73468e">Dashboard</a></li>
                                    <li><a href="?page=6a3b61f42cded56019b264080e226e40">Pengaturan</a></li>
                                    <li class="active"><span>Format Aktivitas</span></li>
                                </ol>
                            </div>
                            <div class="col-sm-12">
                                <div class="panel panel-default">
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $("#jenis").change(function(){
            if($(this).val() == "Pendapatan, Penghasilan"){
              $("#s1").fadeIn();
              $("#s2").fadeOut();
              $("#s3").fadeOut();
              $("#s4").fadeOut();
          }else if($(this).val() == "Aktiva Bersih yang Berakhir Batasannya"){
              $("#s1").fadeOut();
              $("#s2").fadeIn();
              $("#s3").fadeOut();
              $("#s4").fadeOut();
          }else if($(this).val() == "Biaya Program"){
              $("#s1").fadeOut();
              $("#s2").fadeOut();
              $("#s3").fadeIn();
              $("#s4").fadeOut();
          }else if($(this).val() == "Biaya Umum"){
              $("#s1").fadeOut();
              $("#s2").fadeOut();
              $("#s3").fadeOut();
              $("#s4").fadeIn();
    ...
    function tambah() {
        var jenis = "";
          if($("#jenis").val() == "Pendapatan, Penghasilan"){
            jenis = $("#pendapatan_penghasilan").val();
          }else if($("#jenis").val() == "Aktiva Bersih yang Berakhir Batasannya"){
            jenis = $("#aktiva_bersih").val();
          }else if($("#jenis").val() == "Biaya Program"){
            jenis = $("#biaya_program").val();
          }else if($("#jenis").val() == "Biaya Umum"){
        ...
        $.ajax({
            type: "POST",
            url: "index.php?page=6a3b61f42cded56019b264080e226e40&kode=format_aktivitas",
            data: 'aksi=tambah' + '&jenis=' + jenis + '&koderekening=' + kode_rekening + '&status=' + status,
            success: function(msg) {
                if (msg !== "gagal" || msg !== "") {
                    ...
                    if (msg == "gagal") {
                        ...
                        var part5 = '<td class="td-' + msg + '"><textarea readonly id="td-4-' + msg + '" class="txt-' + msg + '" name="uang" cols="5" rows="1" style="overflow:hidden;width: 100%; height:17px; background:none;border:none; resize:none;">' + status + '</textarea></td>';
                        ...
                        var akhir = '</tr>';
                        $('#tbody').append(awal + part2 + part3 + part5 + part4 + akhir);
                        $('#saldoawal').val('');
                    }
                }
            }
