                       ...
                       <div class="row">
                            <div class="col-sm-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading"><h3 class="panel-title">Tambah Jurnal Memorial</h3></div>
                                            ...
                                            <form class="cmxform form-horizontal tasi-form" id="commentForm" method="get" action="#" novalidate>
                                                ...
                                                <div class="col-lg-2">
                                                 ...
                                                 <div class="form-group ">
                                                    ...
                                                    <label for="cemail" class="control-label col-lg-2">Keterangan *</label>
                                                ...
                                                <div class="form-group ">
                                                    <label for="cemail" class="control-label col-lg-2">Jumlah *</label>
                                                        <div class="col-lg-2">
                                                        <input  id="cemail" class="form-control" type="text" name="email" required="" aria-required="true">
                                                        </div>
                                                         <div class="col-lg-2">
                                                        <input  id="cemail" class="form-control" type="text" name="email" required="" aria-required="true"> 
                                                        </div>
