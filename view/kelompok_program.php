...
<body class="fixed-left">
                        ...
                        <div class="row" style="margin-top:30px">
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                ...
                                <ol class="breadcrumb breadcrumb-arrow">
                                    ...
                                    <li class="active"><span>Kelompok Program</span></li>
                                </ol>
                            </div>
                        </div>
                        <!-- Start Widget -->
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading"><h3 class="panel-title">Kelompok Program</h3>
                                    </div>
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <div class="col-lg-2">
                                                        <div class="input-group">
                                                            <input class="form-control " id="nomer_kelompokprogram" type="nomer_kelompokprogram" name="text" required="" aria-required="true">
                                                        </div><!-- input-group -->
                                                    </div>
                                                </div>
                                                <div class="form-group ">
                                                    <label for="cemail" class="control-label col-lg-2">Nama Kelompok *</label>
                                                    <div class="col-lg-4">
                                                        <input class="form-control " id="namakelompok_kelompokprogram" type="namakelompok_kelompokprogram" name="text" required="" aria-required="true">
                                                    </div>
                                                </div>
                                                <div class="form-group">
    ...
    function tambah() {
        ...
        var nomer_kelompokprogram = $('#nomer_kelompokprogram').val();

        var namakelompok_kelompokprogram = $('#namakelompok_kelompokprogram').val();
        ...
        $.ajax({
            ...
            url: "index.php?page=6a3b61f42cded56019b264080e226e40&kode=kelompokprogram",

            data: 'aksi=tambah' + '&nomer_kelompokprogram=' + nomer_kelompokprogram + '&namakelompok_kelompokprogram=' + namakelompok_kelompokprogram,
            ...
            success: function(msg) {
                ...
                if (msg !== "gagal" || msg !== "") {
                    ...
                    $("#tbody").append('<tr class="tr" id="tr-' + msg + '"><td class="td-' + msg + '"><textarea readonly id="td-2-' + msg + '" class="txt-' + msg + '" name="" cols="5" rows="1" style="overflow:hidden;width: 100%; height:17px; background:none;border:none; resize:none;">' + nomer_kelompokprogram + '</textarea></td><td class="td-' + msg + '"><textarea readonly id="td-4-' + msg + '" class="txt-' + msg + '"  name="" cols="5" rows="1" style="overflow:hidden;width: 100%; height:17px; background:none;border:none; resize:none;">' + namakelompok_kelompokprogram + '</textarea></td><td class="actions text-center td-' + msg + '"><a style="cursor:pointer" id="edit-' + msg + '" onClick="edit(\'' + msg + '\')" class="on-default edit-row"><i class="md md-edit"></i></a><a style="cursor:pointer" hidden="" id="save-' + msg + '" class="on-default remove-row" onClick="save_edit(\'' + msg + '\')"><i class="md md-save"></i></a><a style="cursor:pointer" hidden="" id="cancel-edit-' + msg + '" class="on-default remove-row" onClick="cancel_edit(\'' + msg + '\')"><i class="md md-cancel"></i></a><a style="cursor:pointer" onClick="hapus(\'' + msg + '\');"  class="on-default remove-row"><i class="md md-delete"></i></a></td></tr>');

                    $('#nomer_kelompokprogram').val('');

                    $('#namakelompok_kelompokprogram').val('');
    ...
    function hapus(baris) {
        ...
        $.ajax({
            ...
            data: 'aksi=hapus' + '&id_kelompokprogram=' + baris,
    ...
    function save_edit(baris) {
        ...
        var nomer_kelompokprogram = $('#td-2-' + baris).val();

        var namakelompok_kelompokprogram = $('#td-3-' + baris).val();
        ...
        $.ajax({
            ...
            data: 'aksi=ubah&id_kelompokprogram=' + baris + '&nomer_kelompokprogram=' + nomer_kelompokprogram + '&namakelompok_kelompokprogram=' + namakelompok_kelompokprogram,
