                       ...
                       <div class="row">
                            <div class="col-sm-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading"><h3 class="panel-title">Tambah Data Dana Masuk</h3></div>
                                            ...
                                            <form class="cmxform form-horizontal tasi-form" id="commentForm" method="get" action="#" novalidate>
                                                ...
                                                <div class="form-group ">
                                                    <label for="cemail" class="control-label col-lg-2">Rekening *</label>
                                                        <div class="col-lg-4">
                                                        <input  id="cemail" type="radio" name="email" required="" aria-required="true"> Kas
                                                   
                                                        <input  id="cemail" type="radio" name="email" required="" aria-required="true"> Bank
                                                        </div>
                                                </div>
                                                ...
                                                <div class="form-group ">
                                                    <label for="cemail" class="control-label col-lg-2">Status *</label>
                                                        <div class="col-lg-4">
                                                        <input  id="cemail" type="radio" name="email" required="" aria-required="true"> Approved
                                                   
                                                        <input  id="cemail" type="radio" name="email" required="" aria-required="true"> Not Approved
                                                        </div>
                                                </div>
