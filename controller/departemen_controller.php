...
class departemen_controller{
	private $model;
	
	public function __construct(){
		$this->model = new departemen_model();
	}
	...
	private function ubah(){
		$hasil = $this->model->update($_POST['nomor_departemen'],$_POST['nama_departemen'],$_POST['penanggung_jawab'],$_POST['keterangan']);
		return $hasil;
	}
