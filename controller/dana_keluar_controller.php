<?php
require_once("model/dana_keluar_model.php");
require_once("model/tutupBuku_model.php");
class dana_keluar_controller{
	private $model;
	
	public function __construct(){
		$this->model = new dana_keluar_model();
	}
	...
	public function invoke($kode){
		...
		else if($kode === "kodeakhir"){
			$hasil = $this->kodeakhir();
			return $hasil;
		}
		else if($kode === "ubah"){
			$hasil = $this->ubah();
	...
	private function kodeakhir(){
		$hasil = $this->model->kodeakhir();
		return $hasil;
	}
